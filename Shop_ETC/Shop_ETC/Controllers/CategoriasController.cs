...
namespace Shop_ETC.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Idcategoria,NombreCate,Descripcion")] Categorias categorias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Idcategoria,NombreCate,Descripcion")] Categorias categorias)
        {
            if (ModelState.IsValid)
            {
